...
export const CATEGORIES: BodyFatCategory[] = [
  { label: "Atleta",    color: "#3B82F6", range: { male: [2, 13.9],   female: [10, 20.9] } },
  { label: "En forma",  color: "#22C55E", range: { male: [14, 17.9],  female: [21, 24.9] } },
  { label: "Aceptable", color: "#EAB308", range: { male: [18, 24.9],  female: [25, 31.9] } },
